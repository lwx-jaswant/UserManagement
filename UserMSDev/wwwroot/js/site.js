...
var SearchInHTMLTable = function () {
    ...
    input = document.getElementById("inputSearchInTable");
...
var DemoUserAccountLock = function (id) {
    if (id == 1) {
        SwalSimpleAlert("You are not allowed to update demo user info", "warning");
        return true;
    }
    return false;
}
